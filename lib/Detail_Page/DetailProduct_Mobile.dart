        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(child: Text(widget.name,style: TextStyle(fontSize: 25,fontFamily: "k2",fontWeight: FontWeight.bold),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                Container(
                  width: 150,
                  height: 50,
                  decoration: BoxDecoration(
                    ...
                    child: Center(child: Text("${widget.price}\$",style: TextStyle(fontFamily: "price",fontWeight: FontWeight.bold,fontSize: 20,color: Colors.white),))
                ),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(info,style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "des",fontSize: 30),),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Container(
                child: Text(
                  text,style: TextStyle(fontSize: 20,fontFamily: "k1"),
                ),
              ),
            ),
            Padding(
              ...
              child: Container(
                child: Text(
                  desInfo,style: TextStyle(fontSize: 20,fontFamily: "des"),
                ),
              ),
            )
          ],
